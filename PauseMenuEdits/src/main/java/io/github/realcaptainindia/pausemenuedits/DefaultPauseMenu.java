...
public class DefaultPauseMenu extends Screen{
	...
	public DefaultPauseMenu() {
	   ...
	   private void addButtons() {   
		   this.addButton(new Button(this.width / 2 + MenuConfig.Unpause_Button.get().get(0), this.height / 2 - MenuConfig.Unpause_Button.get().get(1), 204, 20, new TranslationTextComponent("menu.returnToGame"), (button2) -> {
	         this.minecraft.displayGuiScreen((Screen)null);
	      }));
		   
		   this.addButton(new Button(this.width / 2 + MenuConfig.Advancement_Button.get().get(0), this.height / 2 - MenuConfig.Advancement_Button.get().get(1), 98, 20, new TranslationTextComponent("gui.advancements"), (button2) -> {
	      ...
	      Button button1 = this.addButton(new Button(this.width / 2 + MenuConfig.Quit_Button.get().get(0), this.height / 2 - MenuConfig.Quit_Button.get().get(1), 204, 20, new TranslationTextComponent("menu.returnToMenu"), (button2) -> {
